 ...
 * @version 2020.04.25 22:57:02 // Generated by ComTest
 *
 */
...
public class TuoteryhmaTest {
  ...
  /** testGetTunnus89 */
  @Test
  public void testGetTunnus89() {    // Tuoteryhma: 89
    Tuoteryhma ruoka= new Tuoteryhma(); 
    assertEquals("From: Tuoteryhma line: 91", 0, ruoka.getTunnus()); 
    ruoka.rekisteroi(); 
    Tuoteryhma juoma = new Tuoteryhma(); 
    juoma.rekisteroi(); 
    int tunnus1 = ruoka.getTunnus(); 
    int tunnus2 = juoma.getTunnus(); 
    assertEquals("From: Tuoteryhma line: 97", tunnus2-1, tunnus1); 
  } // Generated by ComTest END
  ...
  /** testAnnaTiedot109 */
  @Test
  public void testAnnaTiedot109() {    // Tuoteryhma: 109
    Tuoteryhma tuoteryhma = new Tuoteryhma(); 
    tuoteryhma.rekisteroi(); 
    tuoteryhma.annaTiedot("ruoka"); 
    assertEquals("From: Tuoteryhma line: 113", "ruoka", tuoteryhma.getNimi()); 
    Tuoteryhma tuoteryhma1 = new Tuoteryhma(); 
    tuoteryhma1.rekisteroi(); 
    tuoteryhma1.annaTiedot("juoma"); 
    assertEquals("From: Tuoteryhma line: 117", "juoma", tuoteryhma1.getNimi()); 
  } // Generated by ComTest END
}